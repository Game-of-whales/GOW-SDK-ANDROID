...
public class SamsungIapHelper
{
    ...
    {
        ComponentName com = new ComponentName( BILLING_IAP_PACKAGE_NAME,
                                               BILLING_IAP_PACKAGE_NAME + ".iap.activity.AccountActivity" );
    ...
    public void bindIapService( final OnIapBindListener _listener )
    {
        ...
        serviceIntent.setComponent(new ComponentName(BILLING_IAP_PACKAGE_NAME,
                                                     BILLING_IAP_PACKAGE_NAME + ".iap.service.IAPService"));
        // bind to IAPService
        // ====================================================================
    ...
    )
    {
        try
        {
            ...
            ComponentName com = new ComponentName( BILLING_IAP_PACKAGE_NAME,
                                                   BILLING_IAP_PACKAGE_NAME + ".iap.activity.PaymentMethodListActivity" );
        ...
        Runnable OkBtnRunnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                Uri iapDeepLink = Uri.parse( 
                           "samsungapps://ProductDetail/" + BILLING_IAP_PACKAGE_NAME );
                // ------------------------------------------------------------
